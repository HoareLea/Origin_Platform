...
var _require2 = require("@neo4j/graphql-ogm"),
    OGM = _require2.OGM;
...
var neo4j = require("neo4j-driver"); // List of all custom resolvers


var resolvers = require("./utils/resolvers");

var filteredSpacesResolver = require("./utils/ogm-resolver"); // Set environment variables from ../.env
...
var Space = ogm.model("Space");
var ogmRes = {
  Query: {
    // getSpacesFiltered: async (_source, { modelIds, searchString, filterCategories, filterLevels, sort }) => {
    getSpacesFiltered: function () {
      var _getSpacesFiltered = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(parent, args, context, info) {
        var spaces;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                if (filterCategories) {
                  spaces = spaces.filter(function (x) {
                    return args.filterCategories.includes(x.LatestTemplate.Id);
                  });
                }

                return _context.abrupt("return", spaces);
      ...
      function getSpacesFiltered(_x, _x2, _x3, _x4) {
        return _getSpacesFiltered.apply(this, arguments);
      }

      return getSpacesFiltered;
    }()
  }
}; // const allresolvers = Object.assign({}, resolvers, filteredSpacesResolver(Space));

var allresolvers = Object.assign({}, resolvers, ogmRes);
